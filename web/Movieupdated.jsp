    ...
    <a href='contact_us.jsp'><img src="images/contact.gif"></a>
        ...
        <br>
            ...
            if(con!=null){
                 ...
                 int i =stmt.executeUpdate("Update Movie set m_name='"+m_name+"', m_center='"+m_center+"', m_time='"+m_time+"', m_date='"+m_date+"', ticket_cost='"+ticket_cost+"', available='"+available+"' WHERE m_name='"+m_name+"'");        
